...
<HEAD>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#code").click(function () {
                /*添加时间戳，来解除浏览器缓存*/
                $(this).prop("src","code/getCode?time="+(new Date().getTime()))
            })
        })
    </script>
<%-- 相对路径默认调用 --%>
...
<form id="form" action="employee/login" method="post">
<DIV>
    <TABLE cellSpacing=0 cellPadding=0 width=1004 border=0 align="center">
                            ...
                            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
                                ...
                                <TR>
                                    ...
                                    <TD><INPUT class=regtxt title=请填写用户名 maxLength=16
                                               size=16 value="luli" name="username" id=username></TD>
                                </TR>
                                <TR>
                                    <TD align=middle width=81><FONT color=#ffffff>密&nbsp;
                                        码：</FONT></TD>
                                    <TD><INPUT class=regtxt title=请填写密码 type=password
                                               maxLength=16 size=16 name="password" value="123456" id=pass></TD>
                                </TR>
                                <TR>
                                    <TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
                                    <TD><INPUT style="width: 85px;" class=regtxt title=请填写验证码 maxLength=50
                                               size=16 value=8756 name="code">
                                        <jsp:useBean id="date" class="java.util.Date"></jsp:useBean>
                                        <img id="code" style="margin-bottom: -8px" src="code/getCode?time=${date.toString()}" >
                                    </TD>
                                </TR>
                                </TBODY>
                            </TABLE>
        ...
        <TR>
            ...
            <TD rowSpan=3><IMG height=180 alt="" src="images/crm_16.gif"
                               width=24></TD>
            <TD><img title=登录项目平台管理系统 height=48
                       width=86 src="images/crm_17.gif"  onclick="login();" /></TD>
