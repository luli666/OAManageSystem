...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/position/info",
                success:function (msg) {
                    $(msg).each(function () {
                        var option = "<option value='"+ this.id +"'>"+ this.name +"</option>";
                        $("#insert_select").append(option)
                    })
                }
            })
            /*回填角色信息*/
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/role/info",
                success:function (msg) {
                    $(msg).each(function () {
                        var input = "<input type='checkbox' name='ids' value='"+ this.roleid +"' />"+ this.rolename;
                        $("#insert_input").append(input)
                    })
                }
            })
        })
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/employee/insert" method="post">

    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
           style="margin-top:8px">
        <tr bgcolor="#E7E7E7">
            <td height="24" colspan="2" background="skin/images/frame/tbg.gif">&nbsp;添加用户&nbsp;</td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FAFAF1" height="22">职位：</td>
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                <select id="insert_select" name="pFk">
                    <option>--请选择--</option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                <input type="text" name="hiredate" onclick="WdatePicker({skin:'twoer'})"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align='left' id="insert_input" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
