        ...
        <td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
            ...
            <%--<dl class='bitem'>
                <c:forEach items="${sources}" var="source" varStatus="index">
                    ...
                    <dd style='display:<c:if test="${index.count!=1}">none</c:if>' class='sitem' id=items${index.count}_1>
                        <ul class='sitemu' id=0>
                            <c:forEach items="${source.children}" var="source1">
                                <li><a href='${source1.url}' target='main'>${source1.name}</a></li>
                            </c:forEach>
                        </ul>
                    </dd>
                </c:forEach>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id=items1_1>
                    <ul class='sitemu' id=0>
                        ...
                        <li><a href='prsoject-need.jsp' target='main'>需求分析管理</a></li>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:none' class='sitem' id=items2_1>
                    <ul class='sitemu' id=1>
                        ...
                        <li><a href='${pageContext.request.contextPath}/task.jsp' target='main'>任务信息</a></li>
                        <li><a href='${pageContext.request.contextPath}/task-my.jsp' target='main'>我的任务</a></li>
                        <li><a href='${pageContext.request.contextPath}/notice.jsp' target='main'>通知公告</a></li>
                        <li><a href='${pageContext.request.contextPath}/archives.jsp' target='main'>档案管理</a></li>
                        <li><a href='${pageContext.request.contextPath}/message-give.jsp' target='main'>消息推送</a></li>
                        <li><a href='${pageContext.request.contextPath}/message-give.jsp' target='main'>报销管理</a></li>
                        <li><a href='baoxiao-task.jsp' target='main'>报销审批</a> </li>
                        <li><a href='${pageContext.request.contextPath}/bx/list' target='main'>我的报销</a> </li>
                        <li><a href='${pageContext.request.contextPath}/post.jsp' target='main'>发帖</a> </li>
                    </ul>
                </dd>
            </dl>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:none' class='sitem' id=items5_1>
                    <ul class='sitemu' id=4>
                        <li><a href='${pageContext.request.contextPath}/user.jsp' target='main'>人员管理</a> </li>
                        <li><a href='${pageContext.request.contextPath}/pm.jsp' target='main'>权限维护</a> </li>
                        <li><a href='${pageContext.request.contextPath}/role.jsp' target='main'>角色管理</a> </li>
                    </ul>
                </dd>
            </dl>
