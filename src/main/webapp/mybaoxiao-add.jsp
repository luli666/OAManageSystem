...
<head>
    ...
    <script type="application/javascript" src="${pageContext.request.contextPath}/static/js/jquery-3.1.1.js"></script>
...
<form name="form2" action="${pageContext.request.contextPath}/bx/insert" id="form2" method="post">

    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
           style="margin-top:8px">
        <tr bgcolor="#E7E7E7">
            <td height="24" colspan="2" background="skin/images/frame/tbg.gif">&nbsp;添加新的报销单&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                <input type="text" onclick="WdatePicker({skin:'twoer'})"  name="bxtime" placeholder="请输入结束时间"/>
            </td>
        </tr>
